  ...
  return (
    <section className="flex flex-col gap-3 text-justify leading-relaxed">
      ...
      <p className="text-base text-muted-foreground leading-relaxed text-justify">
        Crafting LLM-powered platforms, distributed systems, and creative tools at the intersection of <span className="italic text-[#0B23FF]">Design Engineering</span> and <span className="italic text-[#0B23FF]">AI infrastructure</span> — with a strong product vision and a developer-first mindset.
      </p>
