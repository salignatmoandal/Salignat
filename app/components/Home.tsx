...
import MockCursor from "./ui/FakeMockup";
      ...
      <div className="max-w-2xl w-full flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-gray-400 text-sm leading-relaxed">
            ...
            and combining Design Engineering with LLMs lets me build tools that feel both natural and powerful.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="text-gray-400 text-sm leading-relaxed flex items-center gap-2">
            <BadgeNew />
            Currently, I'm building <span className="underline">Noodl</span>, an AI-powered mind mapping tool.
          </p>
        </div>
